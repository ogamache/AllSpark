...
with open(f"./splits/{dataset}/{split_name}/labeled.txt", "w") as file:
    for index, image in enumerate(list_images):
        if index <= int(total_number_images*train_percentage)/2:
            ...
            file.write(f"{path_images}{img_file_name[0]}_{img_file_name[1]}_{img_file_name[2]}_{img_file_name[3]}_RGB.tif {path_gts}{img_file_name[0]}_{img_file_name[1]}_{img_file_name[2]}_{img_file_name[3]}_label.tif\n")
